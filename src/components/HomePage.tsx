    ...
    <section className="min-h-screen flex items-center relative overflow-hidden page-transition">
      ...
      <div className="container mx-auto px-6 relative z-10 pt-20">
        <div className="max-w-xl fade-in-up opacity-0 delay-200">
          {/* Status badge */}
          <div className="inline-flex items-center gap-2 mb-6 px-3 py-1.5 rounded-full glass text-xs text-muted-foreground">
          ...
          <h1 className="font-display text-4xl md:text-6xl lg:text-7xl font-bold mb-4 uppercase tracking-wider">
            ...
            <br />
            <span className="gradient-text breathing-glow">Yukesh Kumar</span>
          </h1>
          
          <p className="text-muted-foreground text-sm md:text-base mt-6 max-w-md leading-relaxed">
            Lost in thoughts, found in creativity. Building digital experiences that feel alive.
          </p>
          
          {/* CTA buttons */}
          <div className="flex flex-wrap gap-3 mt-8">
            <button className="px-5 py-2.5 rounded-full bg-primary text-primary-foreground text-sm font-medium hover:scale-105 transition-transform duration-200 glow-border">
              View Work
            </button>
            <button className="px-5 py-2.5 rounded-full glass text-sm font-medium hover:bg-primary/10 transition-all duration-200">
              Contact Me
            </button>
          </div>
          ...
          <div className="flex items-center gap-4 mt-10 text-muted-foreground">
            ...
            <div className="flex gap-3">
              <a href="#" className="w-8 h-8 rounded-full glass flex items-center justify-center hover:scale-110 hover:text-primary transition-all duration-200">
